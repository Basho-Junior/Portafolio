        ...
        getPass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mail.getText().toString().isEmpty()){
                    ...
                    UserViewModel user = ViewModelProviders.of(forgotPasswordFragment.this).get(UserViewModel.class);
                    user.getSingleUser(mail.getText().toString()).observe(getActivity(), new Observer<User>() {
                        @Override
                        public void onChanged(@Nullable User auth) {
                            if(auth == null){
