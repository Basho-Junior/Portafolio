...
public class agregarReceta extends javax.swing.JDialog {
    private Object VerRecetass;
    private JTable recetasTabla;
    private panelRecetas panel;
    ...
    private panelRecetas.Recetas getDatosForm(){
        ...
        int minutos = Integer.parseInt(txtMinutos.getText());
             re.setMinutos(minutos);
        return re;
    }
    
    public void addReceta(panelRecetas ver, JTable Tabla){
        panel = ver;
        this.recetasTabla = Tabla;
    }
    
    public void guardar(){
              panel.ProcesoReceta(getDatosForm());
              this.dispose();
