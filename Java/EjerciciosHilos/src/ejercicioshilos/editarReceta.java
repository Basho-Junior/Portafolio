...
public class editarReceta extends javax.swing.JDialog {
    private panelRecetas recipees;
    private String nombre = recipees.nom;
    private final int minutos = panelRecetas.minEdit;
    ...
    public void init(){
        ...
        txtMinutos.setText(Integer.toString(minutos));
    }
   
    private void guardarReceta(){
        if(!txtTitulo.getText().equals("") && !txtMinutos.getText().equals("")){
            if(Integer.parseInt(txtMinutos.getText()) < 59){
             panelRecetas.Recetas re = new panelRecetas.Recetas();
             re.setNombre(txtTitulo.getText());
             re.setMinutos(Integer.parseInt(txtMinutos.getText()));
             recipees.Actualizacion(re);
             this.dispose();
         }
            } else{
                JOptionPane.showMessageDialog(null, "No se pudo actualizar debido a un error.");
                 this.dispose();
            }
            
    }
    
    public void Llamada(panelRecetas recetas){
        this.recipees = recetas;
    }
