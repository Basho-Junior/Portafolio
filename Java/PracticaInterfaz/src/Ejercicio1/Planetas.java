 ...
 * @author Junior
 */
public class Planetas extends SistemaSolar implements ImplementacionSolar {
    
    public Planetas(double masa, double diametro, double distancia, double periodo_rotacion, double periodo_traslacion) {
