...
public class UpdateDeleteCategoryFragment extends Fragment {
                ...
                new AlertDialog.Builder(getContext())
                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener()
                        {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                CategoryViewModel categoryViewModel =  ViewModelProviders.of(UpdateDeleteCategoryFragment.this).get(CategoryViewModel.class);
                                categoryViewModel.deleteById(receivedBundle.getInt("CATEGORY_ID"));
                            }
    ...
    private void updateCategory() {
        ...
        if(cambioImagen)
        {
            category.setImage(idImagen);
        }
        category.setId(idCategory);
        categoryViewModel.update(category);
        Toast.makeText(requireActivity().getApplicationContext(), "UPDATED ", Toast.LENGTH_SHORT).show();
    }
