...
<html>
    ...
    <div class="card-columns">
        <div class="card">
          <img class="card-img-top" src="../img/110330808302.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Modern Frying Pan</h5>
            <p class="card-text">$20</p>
          </div>
        </div>
        <div class="card p-3">
          <blockquote class="blockquote mb-0 card-body">
            <img class="card-img" src="../img/26364143_1798155523814897_2422485816937807872_n.jpg" alt="Card image">
            <p>Cooking Pot<br>
            $20
            </p>
        ...
        <div class="card">
          <img class="card-img-top" src="../img/26269306_183805378884509_8124265634948186112_n.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">OPCKitchen Pack</h5>
        ...
        <div class="card bg-primary text-white text-center p-3">
          <blockquote class="blockquote mb-0">
            <img class="card-img" src="../img/26155152_1929228544007636_6839602313548529664_n.jpg" alt="Card image">
            <p>Potato Peeler<br>
            $13
            </p>
            <footer class="blockquote-footer">
        ...
        <div class="card text-center">
          <div class="card-body">
            <img class="card-img" src="../img/item_XL_23737904_34222562.jpg" alt="Card image">
        ...
        <div class="card">
          <img class="card-img" src="../img/rBVaI1m4peGABbowAAMS4FNrRLA009.jpg" alt="Card image">
        </div>
        <div class="card p-3 text-right">
          <blockquote class="blockquote mb-0">
            <p>Pineappel Beaker<br>
              $10
            </p>
            <footer class="blockquote-footer">
              <small class="text-muted">
        ...
        <div class="card">
          <div class="card-body">
            <img class="card-img" src="../img/Upspirit-Stainless-Steel-font-b-Kitchen-b-font-font-b-Knives-b-font-3-5-5-500x500.jpg" alt="Card image">
            <h5 class="card-title">Knives Pack</h5>
            <p class="card-text">$12</p>
            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
          </div>
        </div>
