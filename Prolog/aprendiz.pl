...
criatura(P, centauro) :-  cuadrupeda(P),humanoide(P),animal(P),tamanio(P,mediana),omnivora(P),es(P,guerrera),tiene(P,pezunias).


criatura(P, pegaso)   :-  cuadrupeda(P),animal(P),hermosa(P),tamanio(P,mediana),herbivora(P),vuela(P),tiene(P,pezunias).


criatura(P, grifo) :-     cuadrupeda(P),animal(P),apariencia(P,feroz),tamanio(P,mediana),omnivora(P),es(P,guerrera),vuela(P),tiene(P,garras).


criatura(P, sirena) :-    humanoide(P),animal(P),hermosa(P),tamanio(P,mediana),omnivora(P),vive(P,en_grupo),habita(P,mares),tiene(P,escamas),puede(P,cantar).


criatura(P, cecaelia) :-  humanoide(P),animal(P),hermosa(P),tamanio(P,mediana),omnivora(P),habita(P,mares),vive(P,en_soledad),tiene(P,ventosas).


criatura(P, dragon) :-    cuadrupeda(P),apariencia(P,feroz),tamanio(P,grande),carnivora(P),vuela(P),puede(P,usar_fuego).


criatura(P, fenix) :-     bipeda(P),tamanio(P,mediana),omnivora(P),vuela(P),puede(P,usar_fuego).
