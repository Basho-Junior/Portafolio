...
% Se desea saber cuáles continentes tienen una densidad poblacional por
...
%Se desea obtener una lista de los continentes que tienen límites marítimos con otros continentes.
...
%Una dependencia es un territorio que por diversas razones no goza de los privilegios de total independencia o soberanía, ni hace parte integral del estado que lo gobierna. Se desea saber cuáles continentes tienen una tasa de dependencias mayor al 70%. Tome en cuenta que para Antártida esta consulta debe devolver falso.
...
%Se desea saber cuántos son los continentes que tienen en su territorio al menos un 0.5% de países no reconocidos.
