%Explique el por qué  de la salida de la consulta realizada al siguiente programa (25%):
%a:-b,!,p.
%a:-r.
%b:-q.
%b:-e.
...
%¿Recuerda el programa que hicimos que nos devolvía barquillas de 3 bolas? Modifíquelo para que no permita barquillas con sabores de bolas que no sean constantes simbólicas y para que no genere barquillas con dos sabores iguales. Las de 3 sabores iguales sin son permitidas. Estos son los hechos bolas que puede usar para probar (50%):
