...
% Obtener los planetas en donde el día es más corto que en la tierra,
...
% Obtener el tiempo de traslación de los planetas que tienen más de un
% satélite.
...
% Obtener cuantos planetas sin satélites debo cruzar para ir de un
% planeta a otro.


%¿Es cierto que los planetas telúricos no tienen satélites?
