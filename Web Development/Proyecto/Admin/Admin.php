...
<html>
    ...
    <body>
            <div class="row"><!--Aqui creamos una lista-->
                    <div class="col-3">
                      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical"><!--Asignamos que sea desplegable de forma vertical-->
                        <hr>
                        <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">DashBoard</a><!--Aqui colocamos el nombre de las lista y los valores que van 
                        tener en este caso decimos que este sera el que se presente activo cuando entremos-->
                        <hr>
                    ...
                    <div class="col-9">
                      <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab"><!--Al darle click a una opcion se abre esta pantalla con la informacion que le pongamos-->
                        <br>
                        <center><nav class="navbar navbar-light bg-light">
                          <a class="navbar-brand">Search an Account!</a><!--Aqui buscamos la informacion de usuario al escribir su nombre de uso-->
                        ...
                        <br>
                        <h1>Accounts<span class="badge badge-secondary">Shop Monster</span></h1><!--Aqui colocamos el titulo-->
                        <br>
                        </center>
                          <?php
