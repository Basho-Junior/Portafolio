            ...
            <div class="row">
                    <div class="col-3">
                      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <hr>
                        <a class="nav-link active" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Products</a>
                        <hr>
                    ...
                    <div class="col-9">
                      <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <input type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#exampleModal2" data-whatever="@mdo" value="Add Products">
                          ...
                          <?php
                              require '../php/conexion.php';
                              if($_POST['busP']==""||empty($_POST['busP'])){
                              ...
                              <table id="tabla" class="tabla">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><button href="../php/Delete.php?cod_product=<?php echo $productos['cod_product']; ?>" type="button" class="btn btn-primary">Delete</button></td>
                                  </tr>
                                    <?php } 
                                  }else{
                                    $sql="Select cod_product, nombre_producto,precio, cantidad, categorias.nombre from productos, categorias where productos.id_categoria = categorias.id_categoria and nombre_producto like '%".$_POST['busP']."%'";
                              $consulta= $cn->query($sql);
                              ?>
                              <table id="tabla" class="tabla">
                                <thead>
