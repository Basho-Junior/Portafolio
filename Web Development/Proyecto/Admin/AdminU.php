            ...
            <div class="row">
                    <div class="col-3">
                      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <hr>
                        <a class="nav-link" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="false">DashBoard</a>
                        <hr>
                        <a class="nav-link active" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="true">Accounts</a>
                        <hr>
                    ...
                    <div class="col-9">
                      <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <?php
                              ...
                              if($_POST['busU']==""||empty($_POST['busU'])){
                              ...
                              <table id="tabla" class="tabla">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    $sql="Select username, nombre, apellido, email, direccion from usuarios where username like '%".$_POST['busU']."%'";
                                    $consulta= $cn->query($sql);
                                    ?>
                                    <table id="tabla" class="tabla">
                                      <thead>
