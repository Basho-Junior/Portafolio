...
<html>
    ...
    <div class="card-columns">
        <div class="card">
          <img class="card-img-top" src="../img/Fish-Bone-Fishing-Hook-Pendant-Necklaces-Punk-Style-Men-Stainless-Steel-Link-Chain-3-Colors-Personality_large.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Fish Chain</h5>
            <p class="card-text">$15</p>
          </div>
        </div>
        <div class="card p-3">
          <blockquote class="blockquote mb-0 card-body">
            <img class="card-img" src="../img/71iMbgXjO-L._UX385_.jpg" alt="Card image">
            <p>HITOP Casual School Backpack<br>
            $45
            </p>
        ...
        <div class="card">
          <img class="card-img-top" src="../img/fashion-s55-wireless-headphones-bluetooth.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">iLEPO Headphones</h5>
        ...
        <div class="card bg-primary text-white text-center p-3">
          <blockquote class="blockquote mb-0">
            <img class="card-img" src="../img/fbe9a01955383183d0f6bf1e6ab18f9e.jpg" alt="Card image">
            <p>Pokemon Teddy Bear<br>
            $10
            </p>
            <footer class="blockquote-footer">
              <small>
        ...
        <div class="card text-center">
          <div class="card-body">
            <img class="card-img" src="../img/pens.jpg" alt="Card image">
            <h5 class="card-title">Pens Kit</h5>
            <p class="card-text">$15</p>
            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
          </div>
        </div>
        <div class="card">
          <img class="card-img" src="../img/dead-tidy-720x648.jpg" alt="Card image">
        </div>
        <div class="card p-3 text-right">
          <blockquote class="blockquote mb-0">
            <p>Dead Tidy Desk Organizer<br>
              $10
            </p>
            <footer class="blockquote-footer">
              <small class="text-muted">
        ...
        <div class="card">
          <div class="card-body">
            <img class="card-img" src="../img/v-Black__554501737_720x.jpg" alt="Card image">
            <h5 class="card-title">Mini Camera HD 1080P</h5>
