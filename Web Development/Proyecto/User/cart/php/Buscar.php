    <!--Al ingresar el nombre del producto que se desea buscar se abre esta pagina
	inicializando asi un asentencia sql con el valor ingresado en el search-->
<?php
/*
...
*/
	$busc=$_POST['bus'];
	$products = $cn->query("select * from productos where nombre_producto Like '%$busc%'");
	?>
